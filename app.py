...
apps = [
    ...
    {"name": "5. 미국주식 재무 비교", "url": "https://stock-dashboard-tle5fvdmqujrqrvrqdb8c3.streamlit.app/", "desc": "미국 개별주 vs 벤치마크 종목 주요 재무지표 비교"},
    {"name": "6. 레버리지 시뮬레이터", "url": "https://leverage-visualizer-od6veunxjczztleqmnfc5k.streamlit.app/", "desc": "가상 2배 ETF와 벤치마크 간 수익률 및 MDD 비교"},
    {"name": "7. 한국주식 재무 비교", "url": "https://k-stock-uki3zdrrysorupc3qd5w7k.streamlit.app/", "desc": "한국 개별주 vs 벤치마크 종목 주요 재무지표 비교"},
    {"name": "8. 국내외 수익률 TOP 10", "url": "https://top-stock-bye8ingxzdftv9nlkc6cpr.streamlit.app/", "desc": "미국 및 한국 주식 수익률 상위 10종목 실시간 순위"},
    {"name": "9. 은퇴 계산기", "url": "https://retirement-calculator-cxvfymmsjzvyicxm6yktvs.streamlit.app/", "desc": "노후 준비를 위한 자금 시뮬레이션"}
]
